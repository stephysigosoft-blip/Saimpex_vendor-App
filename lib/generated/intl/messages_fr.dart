...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(id) => "ID du panier : ${id}";

  static String m1(date) => "Annulé le ${date}";

  static String m2(date) => "Créé le ${date}";

  static String m3(days) => "Expire dans ${days} jours";

  static String m4(id) => "COMMANDE #${id}";

  static String m5(qty) => "Qté : ${qty}";

  static String m6(reason) => "Raison : ${reason}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "aNewUpdateIsAvailableForThisAppPleaseDownload":
        MessageLookupByLibrary.simpleMessage(
          "Une nouvelle mise à jour est disponible pour cette application. Veuillez télécharger la dernière version pour continuer à l’utiliser",
        ),
    ...
    "aboutTheRestaurant": MessageLookupByLibrary.simpleMessage(
    ...
    "activeLabel": MessageLookupByLibrary.simpleMessage("Actif"),
    ...
    "addItemsTitle": MessageLookupByLibrary.simpleMessage(
      "Ajouter des articles",
    ),
    "addMenuTitle": MessageLookupByLibrary.simpleMessage("Ajouter un menu"),
    "addMoreItems": MessageLookupByLibrary.simpleMessage(
      "Ajouter plus d’articles",
    ),
    "addNewItem": MessageLookupByLibrary.simpleMessage(
      "AJOUTER UN NOUVEL ARTICLE",
    ),
    "addNewMenu": MessageLookupByLibrary.simpleMessage(
    ...
    "allItemsFromThisStore": MessageLookupByLibrary.simpleMessage(
      "Tous les articles de ce magasin",
    ),
    "allMenus": MessageLookupByLibrary.simpleMessage("TOUS LES MENUS"),
    "allRestaurants": MessageLookupByLibrary.simpleMessage(
      "Tous les restaurants",
    ),
    "allStores": MessageLookupByLibrary.simpleMessage("Tous les magasins"),
    ...
    "applyCoupon": MessageLookupByLibrary.simpleMessage("Appliquer le coupon"),
    "applyOn": MessageLookupByLibrary.simpleMessage("Appliqué le"),
    "areYouSureYouWantToCancelThisOrder": MessageLookupByLibrary.simpleMessage(
      "Êtes-vous sûr de vouloir annuler cette commande ?",
    ),
    "areYouSureYouWantToClearThisChat": MessageLookupByLibrary.simpleMessage(
      "Êtes-vous sûr de vouloir effacer cette conversation ?",
    ),
    "areYouSureYouWantToDeleteItemFromYour":
        MessageLookupByLibrary.simpleMessage(
    ...
    "areYouSureYouWantToPlaceThisOrder": MessageLookupByLibrary.simpleMessage(
    ...
    "availableTimeHeader": MessageLookupByLibrary.simpleMessage(
      "TEMPS DISPONIBLE",
    ),
    "averageRatingLabel": MessageLookupByLibrary.simpleMessage("Note moyenne"),
    "bankDetails": MessageLookupByLibrary.simpleMessage(
      "COORDONNÉES BANCAIRES",
    ),
    "bankName": MessageLookupByLibrary.simpleMessage("Nom de la banque"),
    "basket": MessageLookupByLibrary.simpleMessage("Panier"),
    "basketDetailsTitle": MessageLookupByLibrary.simpleMessage("Détails"),
    "basketIdLabel": m0,
    "basketItems": MessageLookupByLibrary.simpleMessage("Articles du panier"),
    "basketItemsHeader": MessageLookupByLibrary.simpleMessage(
      "ARTICLES DU PANIER",
    ),
    "basketOrderDetails": MessageLookupByLibrary.simpleMessage(
      "Détails de la commande du panier",
    ),
    "basketOrders": MessageLookupByLibrary.simpleMessage("Commandes du panier"),
    "basketOrderss": MessageLookupByLibrary.simpleMessage(
      "Commandes du panier",
    ),
    ...
    "cameraPermissionIsRequiredToScanBarcodes":
        MessageLookupByLibrary.simpleMessage(
    ...
    "chatNow": MessageLookupByLibrary.simpleMessage("Discuter maintenant"),
    "checkout": MessageLookupByLibrary.simpleMessage("Passer à la caisse"),
    "chooseImageFrom": MessageLookupByLibrary.simpleMessage(
      "Choisir l’image depuis",
    ),
    "classicBasket": MessageLookupByLibrary.simpleMessage("Panier Classique"),
    "clearAll": MessageLookupByLibrary.simpleMessage("Tout effacer"),
    "clickToView": MessageLookupByLibrary.simpleMessage("Cliquer pour voir"),
    ...
    "completedLeaves": MessageLookupByLibrary.simpleMessage("Congés Terminés"),
    "confirmProceed": MessageLookupByLibrary.simpleMessage(
      "Confirmer et continuer",
    ),
    "congratulationsYouveEarned": MessageLookupByLibrary.simpleMessage(
    ...
    "couponCodeCopied": MessageLookupByLibrary.simpleMessage(
      "Code du coupon copié !",
    ),
    "cravingsCallingAnswerWithABite": MessageLookupByLibrary.simpleMessage(
      "Une envie vous appelle ? Répondez avec une bouchée !",
    ),
    "createNewBasket": MessageLookupByLibrary.simpleMessage(
    ...
    "currentlyClosed": MessageLookupByLibrary.simpleMessage(
      "Actuellement fermé",
    ),
    "currentlyClosedOpens": MessageLookupByLibrary.simpleMessage(
      "Actuellement fermé • Ouvre",
    ),
    ...
    "currentlyNoRestaurantsAreAvailableInThisAreaTryAgain":
        MessageLookupByLibrary.simpleMessage(
          "Aucun restaurant n’est disponible dans cette zone pour le moment. Réessayez plus tard",
        ),
    "currentlyNoRestaurantsFound": MessageLookupByLibrary.simpleMessage(
      "Aucun restaurant trouvé actuellement",
    ),
    "currentlyNoStoresFound": MessageLookupByLibrary.simpleMessage(
      "Aucun magasin trouvé actuellement",
    ),
    ...
    "deleteCart": MessageLookupByLibrary.simpleMessage("Supprimer le panier"),
    "deleteChat": MessageLookupByLibrary.simpleMessage(
      "Supprimer la discussion",
    ),
    "delivered": MessageLookupByLibrary.simpleMessage("Livré"),
    "deliveryBoys": MessageLookupByLibrary.simpleMessage("Livreurs"),
    "deliveryFee": MessageLookupByLibrary.simpleMessage("Frais de livraison"),
    "deliveryLocation": MessageLookupByLibrary.simpleMessage(
      "Lieu de livraison",
    ),
    "descriptionEnglishLabel": MessageLookupByLibrary.simpleMessage(
      "Description (anglais)",
    ),
    ...
    "discountPriceLabel": MessageLookupByLibrary.simpleMessage("Prix réduit"),
    ...
    "driverDetails": MessageLookupByLibrary.simpleMessage(
    ...
    "enterDiscountPriceHint": MessageLookupByLibrary.simpleMessage(
      "Entrer le prix réduit",
    ),
    "enterItemNameHint": MessageLookupByLibrary.simpleMessage(
    ...
    "enterPriceHint": MessageLookupByLibrary.simpleMessage("Entrer le prix"),
    ...
    "enterYourQuantityHere": MessageLookupByLibrary.simpleMessage(
      "Entrez la quantité ici",
    ),
    "enterYourWhatsappNumber": MessageLookupByLibrary.simpleMessage(
      "Entrez votre numéro WhatsApp",
    ),
    "expiresInDays": m3,
    "filters": MessageLookupByLibrary.simpleMessage("Filtres"),
    "filtersSorting": MessageLookupByLibrary.simpleMessage("Filtres et tri"),
    "findSomethingFromThisRestaurant": MessageLookupByLibrary.simpleMessage(
      "Trouvez quelque chose dans ce restaurant",
    ),
    "food": MessageLookupByLibrary.simpleMessage("Nourriture"),
    "foodPermit": MessageLookupByLibrary.simpleMessage("Permis alimentaire"),
    ...
    "helpSupport": MessageLookupByLibrary.simpleMessage("Aide et assistance"),
    "holderName": MessageLookupByLibrary.simpleMessage("Nom du Titulaire"),
    "home": MessageLookupByLibrary.simpleMessage("Accueil"),
    "hr24": MessageLookupByLibrary.simpleMessage("24 Hr"),
    "ibanNumber": MessageLookupByLibrary.simpleMessage("Numéro IBAN"),
    ...
    "itemImageLabel": MessageLookupByLibrary.simpleMessage(
      "Image de l\'article",
    ),
    "itemNameEnglishLabel": MessageLookupByLibrary.simpleMessage(
      "Nom de l\'article (anglais)",
    ),
    "itemOrdersHeader": MessageLookupByLibrary.simpleMessage(
      "COMMANDES D\'ARTICLES",
    ),
    "itemTotal": MessageLookupByLibrary.simpleMessage("Total de l’article"),
    "itemTypeLabel": MessageLookupByLibrary.simpleMessage("Type d\'article"),
    "items": MessageLookupByLibrary.simpleMessage("Articles"),
    "itemsCountLabel": MessageLookupByLibrary.simpleMessage(
      "NOMBRE D\'ARTICLES",
    ),
    "itemsTotalLabel": MessageLookupByLibrary.simpleMessage(
      "TOTAL DES ARTICLES",
    ),
    "joinedOn": MessageLookupByLibrary.simpleMessage("Inscrit le"),
    "km": MessageLookupByLibrary.simpleMessage("km"),
    "language": MessageLookupByLibrary.simpleMessage("Langue"),
    "lastPurchaseLabel": MessageLookupByLibrary.simpleMessage("Dernier achat"),
    "leaves": MessageLookupByLibrary.simpleMessage("Congés"),
    "leavesHistory": MessageLookupByLibrary.simpleMessage(
    ...
    "loginOrSignUp": MessageLookupByLibrary.simpleMessage(
      "Connexion ou inscription",
    ),
    "logout": MessageLookupByLibrary.simpleMessage("Déconnexion"),
    "lunchMenu": MessageLookupByLibrary.simpleMessage("Menu du Déjeuner"),
    "mAgo": MessageLookupByLibrary.simpleMessage("il y a"),
    "markLeave": MessageLookupByLibrary.simpleMessage("MARQUER UN CONGÉ"),
    "markLeaveButton": MessageLookupByLibrary.simpleMessage("Marquer le Congé"),
    "maxAllowedQuantityLabel": MessageLookupByLibrary.simpleMessage(
      "Quantité maximale autorisée",
    ),
    "membership": MessageLookupByLibrary.simpleMessage("Adhésion"),
    "menu": MessageLookupByLibrary.simpleMessage("Menu"),
    "menuBulkImport": MessageLookupByLibrary.simpleMessage(
      "Importation Massive de Menu",
    ),
    ...
    "morePoints": MessageLookupByLibrary.simpleMessage("Plus de points"),
    "mruOnThisOrder": MessageLookupByLibrary.simpleMessage(
      "MRU sur cette commande",
    ),
    "mruWithThisCode": MessageLookupByLibrary.simpleMessage("MRU avec ce code"),
    "myOrders": MessageLookupByLibrary.simpleMessage("Mes commandes"),
    "myPoints": MessageLookupByLibrary.simpleMessage("Mes points"),
    "myRestaurant": MessageLookupByLibrary.simpleMessage("Mon Restaurant"),
    "name": MessageLookupByLibrary.simpleMessage("Nom"),
    "nationalIdNumber": MessageLookupByLibrary.simpleMessage(
      "Numéro d\'ID national",
    ),
    "nationalIdType": MessageLookupByLibrary.simpleMessage(
      "Type d\'ID national",
    ),
    "need": MessageLookupByLibrary.simpleMessage("Besoin"),
    "needItFreshAddItToYourCart": MessageLookupByLibrary.simpleMessage(
      "Besoin de fraîcheur ? Ajoutez-le à votre panier !",
    ),
    "needsAnUpdate": MessageLookupByLibrary.simpleMessage(
    ...
    "noCouponsAvailableRightNow": MessageLookupByLibrary.simpleMessage(
      "Aucun coupon disponible pour le moment",
    ),
    "noDeliveryBoysFound": MessageLookupByLibrary.simpleMessage(
    ...
    "noGroceryOrdersYet": MessageLookupByLibrary.simpleMessage(
      "Aucune commande d’épicerie pour le moment",
    ),
    ...
    "noOptionsAvailable": MessageLookupByLibrary.simpleMessage(
      "Aucune option disponible",
    ),
    "noOrderDetailsFound": MessageLookupByLibrary.simpleMessage(
    ...
    "noRestaurantsFounds": MessageLookupByLibrary.simpleMessage(
      "Aucun restaurant trouvé",
    ),
    "noStoresFound": MessageLookupByLibrary.simpleMessage(
      "Aucun magasin trouvé",
    ),
    "noTrackingDetailsFound": MessageLookupByLibrary.simpleMessage(
      "Aucun détail de suivi trouvé",
    ),
    "noTransactionHistoryAvailable": MessageLookupByLibrary.simpleMessage(
      "Aucun historique de transactions disponible",
    ),
    "notification": MessageLookupByLibrary.simpleMessage("Notification"),
    "notifications": MessageLookupByLibrary.simpleMessage("Notifications"),
    "now": MessageLookupByLibrary.simpleMessage("Maintenant"),
    "off": MessageLookupByLibrary.simpleMessage("OFF"),
    "onlinePayment": MessageLookupByLibrary.simpleMessage("Paiement en ligne"),
    "orderColon": MessageLookupByLibrary.simpleMessage("Commande : "),
    "orderDetails": MessageLookupByLibrary.simpleMessage(
    ...
    "orderedItems": MessageLookupByLibrary.simpleMessage("Articles commandés"),
    "ordersCountLabel": MessageLookupByLibrary.simpleMessage(
      "NOMBRE DE COMMANDES",
    ),
    ...
    "ownerEmail": MessageLookupByLibrary.simpleMessage("Email du propriétaire"),
    "ownerIdentityProof": MessageLookupByLibrary.simpleMessage(
      "PREUVE D\'IDENTITÉ DU PROPRIÉTAIRE",
    ),
    "ownerName": MessageLookupByLibrary.simpleMessage("Nom du propriétaire"),
    "ownerPhone": MessageLookupByLibrary.simpleMessage(
      "Téléphone du propriétaire",
    ),
    "packagingCost": MessageLookupByLibrary.simpleMessage("Coût d\'emballage"),
    "pay": MessageLookupByLibrary.simpleMessage("Payer"),
    "paymentDetails": MessageLookupByLibrary.simpleMessage(
      "Détails du paiement",
    ),
    "paymentSummaryDetails": MessageLookupByLibrary.simpleMessage(
      "DÉTAILS DE PAIEMENT",
    ),
    ...
    "pickWhatYouWantAndFillYourBasket": MessageLookupByLibrary.simpleMessage(
      "Choisissez ce que vous voulez et remplissez votre panier !",
    ),
    "pickYourFavouritesAndStartYourFeast": MessageLookupByLibrary.simpleMessage(
      "Choisissez vos favoris et commencez votre festin !",
    ),
    "placeOrder": MessageLookupByLibrary.simpleMessage("Passer la commande"),
    "pleaseAddYourItemsToCart": MessageLookupByLibrary.simpleMessage(
      "Veuillez ajouter des articles au panier",
    ),
    "pleaseChooseLocation": MessageLookupByLibrary.simpleMessage(
      "Veuillez choisir un emplacement",
    ),
    "pleaseEnterCouponCode": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer le code du coupon",
    ),
    "pleaseEnterNameOfLengthAtleast3": MessageLookupByLibrary.simpleMessage(
    ...
    "pleaseEnterTheVerificationCodeSentTo":
        MessageLookupByLibrary.simpleMessage(
          "Veuillez saisir le code de vérification envoyé à",
        ),
    "pleaseEnterValidOtp": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer un OTP valide",
    ),
    "pleaseEnterYourMobileNumber": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer votre numéro de mobile",
    ),
    "pleaseEnterYourName": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer votre nom",
    ),
    "pleaseEnterYourQuantity": MessageLookupByLibrary.simpleMessage(
    ...
    "preparationTimeLabel": MessageLookupByLibrary.simpleMessage(
    ...
    "proceed": MessageLookupByLibrary.simpleMessage("Continuer"),
    ...
    "rateOrder": MessageLookupByLibrary.simpleMessage("Évaluer la commande"),
    "rateOrderedItems": MessageLookupByLibrary.simpleMessage(
      "Évaluer les articles commandés",
    ),
    "rateRestaurantReview": MessageLookupByLibrary.simpleMessage(
      "Évaluer l’avis du restaurant",
    ),
    "rateStoreReview": MessageLookupByLibrary.simpleMessage(
      "Évaluer l’avis du magasin",
    ),
    "rateYourDeliveryExperience": MessageLookupByLibrary.simpleMessage(
      "Évaluez votre expérience de livraison",
    ),
    "rateYourOrder": MessageLookupByLibrary.simpleMessage(
      "Évaluez votre commande",
    ),
    "ratingReviews": MessageLookupByLibrary.simpleMessage(
      "ÉVALUATIONS ET AVIS",
    ),
    "ready": MessageLookupByLibrary.simpleMessage("Prêt"),
    "reasonColonLabel": m6,
    "reasonForLeave": MessageLookupByLibrary.simpleMessage("Motif du Congé"),
    "reasonLabel": MessageLookupByLibrary.simpleMessage("Raison"),
    "receivedPayouts": MessageLookupByLibrary.simpleMessage("Paiements Reçus"),
    "redeemNow": MessageLookupByLibrary.simpleMessage("Échanger maintenant"),
    "redeemPointsLabel": MessageLookupByLibrary.simpleMessage(
      "POINTS DE RACHAT",
    ),
    "redeemableRewards": MessageLookupByLibrary.simpleMessage(
      "Récompenses échangeables",
    ),
    "redeemed": MessageLookupByLibrary.simpleMessage("Utilisé"),
    "redeemedAmount": MessageLookupByLibrary.simpleMessage("Montant utilisé"),
    "redeemedCustomersHeader": MessageLookupByLibrary.simpleMessage(
      "CLIENTS AYANT RACHETÉ",
    ),
    "redeemedPoints": MessageLookupByLibrary.simpleMessage("Points utilisés"),
    "redeemedStatus": MessageLookupByLibrary.simpleMessage("RACHETÉ"),
    "regDate": MessageLookupByLibrary.simpleMessage("Date d\'Enreg."),
    "regNumber": MessageLookupByLibrary.simpleMessage("Numéro d\'Enreg."),
    "registrationDetails": MessageLookupByLibrary.simpleMessage(
      "DÉTAILS D\'INSCRIPTION",
    ),
    "remove": MessageLookupByLibrary.simpleMessage("Supprimer"),
    "replace": MessageLookupByLibrary.simpleMessage("Remplacer"),
    "replaceCartItem": MessageLookupByLibrary.simpleMessage(
      "Remplacer l’article du panier ?",
    ),
    "resendCodeIn30Sec": MessageLookupByLibrary.simpleMessage(
    ...
    "restaurantCommission": MessageLookupByLibrary.simpleMessage(
      "Pourcentage de commission du restaurant par commande",
    ),
    ...
    "scanBarcode": MessageLookupByLibrary.simpleMessage(
      "Scanner le code-barres",
    ),
    "scheduled": MessageLookupByLibrary.simpleMessage("PROGRAMMÉ"),
    "search": MessageLookupByLibrary.simpleMessage("Rechercher"),
    "searchByIdName": MessageLookupByLibrary.simpleMessage(
      "Recherche par ID, nom",
    ),
    "searchCategories": MessageLookupByLibrary.simpleMessage(
      "Rechercher des catégories",
    ),
    "searchForAreaStreetName": MessageLookupByLibrary.simpleMessage(
      "Rechercher une zone ou un nom de rue.....",
    ),
    ...
    "selectAttributeHint": MessageLookupByLibrary.simpleMessage(
    ...
    "selectTagHint": MessageLookupByLibrary.simpleMessage(
      "Sélectionner une étiquette",
    ),
    "selectTypeHint": MessageLookupByLibrary.simpleMessage(
    ...
    "serialNoLabel": MessageLookupByLibrary.simpleMessage("Numéro de série"),
    "serverDown": MessageLookupByLibrary.simpleMessage("Serveur indisponible"),
    "serviceDeliveryCharge": MessageLookupByLibrary.simpleMessage(
      "Frais de service de livraison",
    ),
    "settings": MessageLookupByLibrary.simpleMessage("Paramètres"),
    "sorryWereDownForMaintenanceWellBeBackUpShortly":
        MessageLookupByLibrary.simpleMessage(
          "Désolé, nous sommes en maintenance. Nous serons de retour très bientôt",
        ),
    "sortBy": MessageLookupByLibrary.simpleMessage("Trier par"),
    "sortFilter": MessageLookupByLibrary.simpleMessage("Trier et filtrer"),
    ...
    "submitRating": MessageLookupByLibrary.simpleMessage(
      "Soumettre l’évaluation",
    ),
    "sunday": MessageLookupByLibrary.simpleMessage("Dimanche"),
    "sushiPlatter": MessageLookupByLibrary.simpleMessage("Plateau de Sushi"),
    ...
    "toDate": MessageLookupByLibrary.simpleMessage("Date de Fin"),
    "toPay": MessageLookupByLibrary.simpleMessage("À payer"),
    "today": MessageLookupByLibrary.simpleMessage("Aujourd’hui"),
    "todaysOrders": MessageLookupByLibrary.simpleMessage("Commandes du Jour"),
    "topSellingDishes": MessageLookupByLibrary.simpleMessage(
      "Plats les plus vendus",
    ),
    "totalBill": MessageLookupByLibrary.simpleMessage("Total de la facture"),
    "totalOrdersStat": MessageLookupByLibrary.simpleMessage(
      "Total des Commandes",
    ),
    "totalProfit": MessageLookupByLibrary.simpleMessage("Bénéfice Total"),
    "totalReviewsStat": MessageLookupByLibrary.simpleMessage("Total des avis"),
    "trackOrder": MessageLookupByLibrary.simpleMessage("Suivre la commande"),
    "trackYourOrder": MessageLookupByLibrary.simpleMessage(
      "Suivre votre commande",
    ),
    "tradeLicense": MessageLookupByLibrary.simpleMessage("Licence commerciale"),
    "tradeLicenseNo": MessageLookupByLibrary.simpleMessage(
    ...
    "typeYourReviewHere": MessageLookupByLibrary.simpleMessage(
      "Tapez votre avis ici",
    ),
    "unknown": MessageLookupByLibrary.simpleMessage("Inconnu"),
    "unknownDriver": MessageLookupByLibrary.simpleMessage("Chauffeur inconnu"),
    "unknownVendor": MessageLookupByLibrary.simpleMessage("Vendeur inconnu"),
    "upcomingLeaves": MessageLookupByLibrary.simpleMessage("Congés à Venir"),
    "update": MessageLookupByLibrary.simpleMessage("Mettre à jour"),
    "updateDetailsButton": MessageLookupByLibrary.simpleMessage(
      "Mettre à jour les détails",
    ),
    "uploadImage": MessageLookupByLibrary.simpleMessage("Charger une image"),
    "uploadImageHint": MessageLookupByLibrary.simpleMessage(
      "Télécharger l\'image ici",
    ),
    "upto": MessageLookupByLibrary.simpleMessage("Jusqu’à"),
    "username": MessageLookupByLibrary.simpleMessage("Nom d\'utilisateur"),
    "vatGstNumber": MessageLookupByLibrary.simpleMessage("Numéro de TVA/GST"),
    "vegBurger": MessageLookupByLibrary.simpleMessage("Burger Végétarien"),
    "vendor": MessageLookupByLibrary.simpleMessage("Vendeur"),
    "vendorType": MessageLookupByLibrary.simpleMessage("Type de vendeur"),
    "version": MessageLookupByLibrary.simpleMessage("Version"),
    "viewAll": MessageLookupByLibrary.simpleMessage("Voir Tout"),
    "viewAllCoupons": MessageLookupByLibrary.simpleMessage(
      "Voir tous les coupons",
    ),
    "viewDetails": MessageLookupByLibrary.simpleMessage("Voir les détails"),
    "viewOrders": MessageLookupByLibrary.simpleMessage("Voir les commandes"),
    "wednesday": MessageLookupByLibrary.simpleMessage("Mercredi"),
    "wellBeBackSoon": MessageLookupByLibrary.simpleMessage(
    ...
    "whatDoYouNeedToday": MessageLookupByLibrary.simpleMessage(
      "De quoi avez-vous besoin aujourd’hui ?",
    ),
    "whatsYourName": MessageLookupByLibrary.simpleMessage(
      "Quel est votre nom ?",
    ),
    "withThisCode": MessageLookupByLibrary.simpleMessage("% avec ce code"),
    "workingHours": MessageLookupByLibrary.simpleMessage("Heures de Travail"),
    "yes": MessageLookupByLibrary.simpleMessage("Oui"),
    "yesLabel": MessageLookupByLibrary.simpleMessage("Oui"),
    "yesterday": MessageLookupByLibrary.simpleMessage("Hier"),
    "youAreLoggedOutSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Vous vous êtes déconnecté avec succès",
    ),
    "youCannotDeleteThisItemFromHereToCheckoutMinimum":
        MessageLookupByLibrary.simpleMessage(
          "Vous ne pouvez pas supprimer cet article d’ici. Au moins un produit est requis pour passer à la caisse",
        ),
    "youMightAlsoLike": MessageLookupByLibrary.simpleMessage(
      "Vous pourriez aussi aimer",
    ),
    "youSaved": MessageLookupByLibrary.simpleMessage("Vous avez économisé"),
    "yourCartHasDishesFrom": MessageLookupByLibrary.simpleMessage(
      "Votre panier contient des articles de",
    ),
    "yourCartIsEmpty": MessageLookupByLibrary.simpleMessage(
      "Votre panier est vide",
    ),
    "yourOrderHasBeenDelivered": MessageLookupByLibrary.simpleMessage(
      "Votre commande a été livrée",
    ),
    "yourOrderHasBeenPickedUpForDelivery": MessageLookupByLibrary.simpleMessage(
      "Votre commande a été récupérée pour la livraison",
    ),
    "yourOrderHasBeenReceived": MessageLookupByLibrary.simpleMessage(
      "Votre commande a été reçue",
    ),
    "yourOrders": MessageLookupByLibrary.simpleMessage("Vos commandes"),
    "yourTrustedFoodGroceryDeliveryPartner": MessageLookupByLibrary.simpleMessage(
