...
import 'package:saimpex_vendor/controller/grocery_details_controller.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                S.of(context).areYouSureYouWantToDeleteItemFromYour,
                style: GoogleFonts.rubik(
                  fontSize: 13,
                  color: Colors.black,
                  height: 1.4,
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        if (route == "cart") {
                          cartController.deleteCartItem(context, cartItemId);
                        } else {
                          if (isGrocery == true) {
                            GroceryDetailsController controller = Get.put(
                              GroceryDetailsController(),
                            );
                            controller.replaceCart(context, "delete");
                          } else {
                            controller.replaceCart(context, "delete");
                          }
                        }
